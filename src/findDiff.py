...
for line in gb_trace_log:
    ...
    gb_list.append({"A": int(line_array[1], 16), "FL": line_array[3], "BC": int(line_array[5], 16), "DE": int(line_array[7], 16), "HL": int(
        line_array[9], 16), "Opcode": int(line_array[15].strip(), 16), "PC": int(line_array[13], 16), "CY": line_array[19].strip()})
...
for line in binjgb_trace_log:
    line_array = line.split(" ")
    binjgb_list.append({"A": int(line_array[0].split(":")[1], 16), "F": line_array[1].split(":")[1], "BC": int(line_array[2].split(":")[1], 16), "DE": int(line_array[3].split(
        ":")[1], 16), "HL": int(line_array[4].split(":")[1], 16), "Opcode": int(line_array[11], 16), "PC": int(line_array[6].split(":")[1], 16), "CY": line_array[8].split(")")[0]})
